...
const components = [
  ...
  { name: 'Button Group', href: '/components/button-group', isNew: true },
  ...
  { name: 'Context Menu', href: '/components/context-menu', isNew: true },
  { name: 'Data Table', href: '/components/data-table' },
  { name: 'Date Picker', href: '/components/date-picker', isNew: true },
  ...
  { name: 'Error Boundary', href: '/components/error-boundary' },
  { name: 'Field', href: '/components/field', isNew: true },
  { name: 'Hover Card', href: '/components/hover-card' },
  { name: 'Input', href: '/components/input' },
  { name: 'Input Group', href: '/components/input-group', isNew: true },
  ...
  { name: 'ASCII Shapes', href: '/components/ascii-shapes' },
  { name: 'MC Background', href: '/components/math-curve-background' },
  ...
  { name: 'Resizable', href: '/components/resizable', isNew: true },
  ...
  { name: 'Tour', href: '/components/tour' },
  { name: 'Tree View', href: '/components/tree-view' },
]
